...
(function($){
	...
	$.fn.filedrop = function(options) {
		...
		this.bind('drop', drop).bind('pick', pick).bind('dragenter', dragEnter).bind('dragover', dragOver).bind('dragleave', dragLeave);
	...
	function pick(e, filefield) {
    console.log('filefield', filefield);
    files = filefield.files;
    files_count = files.length;
    console.log('files', files, 'count', files_count);
    upload();
	}
