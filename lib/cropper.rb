...
module Cropper
  ...
  module ClassMethods
    ...
    def has_upload(attachment_name=:image, options={})
      ...
      # allow uploads to be assigned to this class in the UploadsController.
      Cropper.uploadable_classes.push(self.to_s) unless Cropper.uploadable_classes.include?(self.to_s)
      ...
      ## Maintenance
      #
      # *read_[name]_upload* is called before_save. If there is a new upload, or any of its scale and crop values have changed, 
